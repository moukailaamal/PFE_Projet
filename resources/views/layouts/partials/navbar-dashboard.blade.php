    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href="{{ url('/') }}" class="text-xl font-bold flex items-center lg:ml-2.5">
          <img src="{{ asset('images/logo.svg') }}" class="h-6 mr-2" alt="Windster Logo">
      ...
      <div class="flex items-center">
          ...
          <a href="{{ url('/pricing') }}" class="hidden sm:inline-flex ml-5 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3">
